class ElementHandler {
 ...
 findChildElementHandlers(cssClass) {
  ...
  //console.log("findChildElementHandlers", childElements)
 ...
 */
 ...
 setState(name, active) {
  //console.log("set state " + name + " to " + active, this.element.id);
  if (active)
 ...
 activateState(name) {
  ...
  //console.log("activate state " + name, this.element.id);
 }
 
 clearState(name) {
  //this.element.setAttribute("data-" + name, false);
  this.element.classList.remove(name);
  //console.log("clear state " + name, this.element.id);
 }
 ...
 getPreset() {
  ...
  elementNames.forEach(name => {
   ...
   if (inputElement.nodeName == "INPUT") {
    ...
    // console.log("checked ", inputElement)
    }
   }
  });
 ...
 setPreset(preset) {
  ...
  presetNames.forEach(name => {
   let inputElement = this.childElements[name];
   if (inputElement)  {
    //console.log("setPreset:" + name, inputElement)
    if (inputElement.nodeName == "INPUT") {
     if (inputElement.type == "range" || inputElement.type == "number")
