function vumeter(elem, config){
    ...
    var redOn     = 'rgba( 20,  20, 255, 0.6)'; //'rgba(255,  47,  30, 0.6)';
    var redOff    = 'rgba( 10,  10,  64, 0.2)'; //''rgba( 64,  12,   8, 0.2)';
    
    var yellowOn  = 'rgba(255, 215,   5, 0.6)';
    var yellowOff = 'rgba(120,  90,   0, 0.2)';
    
    var greenOn   = 'rgba(190, 140,  50, 0.6)'; //'rgba( 53, 255,  30, 0.6)';
    var greenOff  = 'rgba( 80,  40,  10, 0.2)'; // 'rgba( 64,  32,   8, 0.6)'; //'rgba(13,64,8,0.2)';
