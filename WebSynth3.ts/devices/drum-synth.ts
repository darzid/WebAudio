...
export class DrumSynth extends AudioDevice {
  _noteVoiceMap: { C0: string; C1: string; D1: string; E1: string; };
  _kickModule: any;
  // _openHihatGain: null;
  _context: any;
  constructor(element: HTMLElement, elementClass: string) {
    super(element, elementClass, "DrumSynth");
    Logger.log("Create DrumSynth for element", element);
  ...
  setupAudioGraph() {
    ...
    this._kickModule.setupAudioGraph(this.input);
